// https://github.com/firebase/functions-samples/tree/2ea1ed8f0f381942387b4ef1400ca9d8ca1aea16/fulltext-search-firestore
...
const ALGOLIA_INDEX_NAME = 'course';
const client = algoliasearch(ALGOLIA_ID, ALGOLIA_ADMIN_KEY);
// [END init_algolia]

// [START update_index_function]
// Update the search index every time a blog post is written.
exports.onNoteCreated = functions.firestore.document('course/{courseid}').onCreate((snap, context) => {
